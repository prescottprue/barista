...
export function startTestRun({ firebase }) {
  ...
  const cloudProjectId = 'barista-836b4'
  ...
  return () => {
    firebase.push('requests/callGoogleApi', {
      api: 'compute',
      method: 'POST',
      suffix: `projects/${cloudProjectId}/zones/us-west1-b/instances?souceInstanceTemplate=global/instanceTemplates/${instanceTemplateName}`,
