...
// falls back to local bin. NPX is installed as a dev dependency since the npm
// version included with node 6.11.* (currently used node version) does not
// include it by default
const FIREBASE_TOOLS_BASE_COMMAND = '$(npm bin)/npx firebase'
